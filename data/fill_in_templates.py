...
ec_sample_path = os.path.join(sample_path, "EC Numbers", "ec_numbers_samples.tsv")
ca_sample_a_path = os.path.join(sample_path, "Catalytic Activity", "catalytic_activity_samples_a.tsv")
ca_sample_b_path = os.path.join(sample_path, "Catalytic Activity", "catalytic_activity_samples_b.tsv")
cf_sample_path = os.path.join(sample_path, "Cofactors", "cofactors_samples.tsv")
cf_sample_c_path = os.path.join(sample_path, "Cofactors", "cofactors_samples_residue_level.tsv")
sl_sample_path = os.path.join(sample_path, "Subcellular Location", "subcellular_location_samples.tsv")
pw_sample_path = os.path.join(sample_path, "Pathway", "pathway_samples.tsv")
go_sample_a_path = os.path.join(sample_path, "Gene Ontology", "gene_ontology_samples_a.tsv")
go_sample_b_path = os.path.join(sample_path, "Gene Ontology", "gene_ontology_samples_b.tsv")
go_sample_c_path = os.path.join(sample_path, "Gene Ontology", "gene_ontology_samples_c.tsv")
rg_sample_path = os.path.join(sample_path, "Regions", "regions_samples.tsv")
st_sample_path = os.path.join(sample_path, "Sites", "sites_samples.tsv")
